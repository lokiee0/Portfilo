(function () {
    ...
    const first = "Building secure networks, one line of code at a time.";
    const second = "Cybersecurity specialist with Python expertise.";
    const third =
        "Protecting digital assets through innovative security solutions. Based in Tiruvannamalai, India.";
